...
namespace Obvs.AzureServiceBus.Configuration
{
    ...
    public interface ICanSpecifyAzureServiceBusMessagingFactory<TMessage, TCommand, TEvent, TRequest, TResponse> : ICanSpecifyRequestResponseCorrelationProvider<TMessage, TCommand, TEvent, TRequest, TResponse>
        where TMessage : class
        where TCommand : class, TMessage
        where TEvent : class, TMessage
        where TRequest : class, TMessage
        where TResponse : class, TMessage
    {
        ICanSpecifyRequestResponseCorrelationProvider<TMessage, TCommand, TEvent, TRequest, TResponse> WithMessagingFactory(IMessagingFactory messagingFactory);
        ICanSpecifyRequestResponseCorrelationProvider<TMessage, TCommand, TEvent, TRequest, TResponse> WithMessagingFactory(MessagingFactory messagingFactory);
    }

    public interface ICanSpecifyRequestResponseCorrelationProvider<TMessage, TCommand, TEvent, TRequest, TResponse> : ICanSpecifyAzureServiceBusMessagingEntity<TMessage, TCommand, TEvent, TRequest, TResponse>
        where TMessage : class
        where TCommand : class, TMessage
        where TEvent : class, TMessage
        where TRequest : class, TMessage
        where TResponse : class, TMessage
    {
        ICanSpecifyAzureServiceBusMessagingEntity<TMessage, TCommand, TEvent, TRequest, TResponse> WithRequestResponseCorrelationProvider(IBrokeredMessageRequestResponseCorrelationMapper provider);
    }
        ...
        where TServiceMessage : class
    {
        ...
        private AzureServiceBusQueueEndpointProvider<TServiceMessage, TMessage, TCommand, TEvent, TRequest, TResponse> CreateProvider()
        {
            ...
            return new AzureServiceBusQueueEndpointProvider<TServiceMessage, TMessage, TCommand, TEvent, TRequest, TResponse>(_serviceName, _namespaceManager, _messagingFactory, _serializer, _deserializerFactory, _messageTypePathMappings, _assemblyFilter, _typeFilter, _requestResponseCorrelationProvider ?? new DefaultBrokeredMessageRequestResponseCorrelationMapper());
        }
        ...
        public ICanSpecifyRequestResponseCorrelationProvider<TMessage, TCommand, TEvent, TRequest, TResponse> WithMessagingFactory(IMessagingFactory messagingFactory)
        {
        ...
        public ICanSpecifyRequestResponseCorrelationProvider<TMessage, TCommand, TEvent, TRequest, TResponse> WithMessagingFactory(MessagingFactory messagingFactory)
        {
        ...
        public ICanSpecifyAzureServiceBusMessagingEntity<TMessage, TCommand, TEvent, TRequest, TResponse> WithRequestResponseCorrelationProvider(IBrokeredMessageRequestResponseCorrelationMapper provider)
        {
