...
An [Azure ServiceBus](https://docs.microsoft.com/en-us/azure/service-bus-messaging/service-bus-messaging-overview) 
transport support for [the Obvs framework](https://github.com/inter8ection/Obvs).
